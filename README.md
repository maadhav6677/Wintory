...
Wintory is an AI operations copilot for growing independent grocery stores. It helps store owners manage inventory, predict demand, prevent stockouts, and automate purchasing using historical sales data—without requiring complex ERP systems.

## Why Wintory?

Small and medium-sized grocery stores often rely on intuition when deciding what to restock. This often results in:

- Stockouts of fast-moving products
- Overstocking of slow-moving inventory
- Expired products and dead stock
- Working capital locked in excess inventory
- Limited visibility into sales trends

Wintory combines inventory management with AI-powered forecasting to help store owners make smarter purchasing decisions while keeping day-to-day operations simple.
...
| Decision | Why |
|----------|-----|
| **PostgreSQL** | Inventory and sales data are highly relational and require ACID transactions. |
| **Redis + BullMQ** | Enables caching and asynchronous background jobs. |
| **Modular Monolith** | Keeps development simple while maintaining clear module boundaries. |
| **Python AI Service** | Leverages the mature Python machine learning ecosystem. |
| **REST-first** | Simple service communication for the MVP, with the option to adopt gRPC later. |
